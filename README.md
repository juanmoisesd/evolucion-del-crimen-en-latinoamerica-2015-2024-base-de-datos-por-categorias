# Evolución del Crimen en Latinoamérica 2015-2024: Base de Datos por Categorías
...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18740062.svg)](https://doi.org/10.5281/zenodo.18740062)
...
[![Pages](https://img.shields.io/badge/Live-Microsite-brightgreen)](https://juanmoisesd.github.io/evolucion-del-crimen-en-latinoamerica-2015-2024-base-de-datos-por-categorias/)

## Overview
Base de datos sobre la evoluci&oacute;n del crimen en Am&eacute;rica Latina y el Caribe durante el per&iacute;odo 2015-2024, compilada a partir de fuentes secundarias (UNODC, Insight Crime, Prosegur Research, Banco Mundial, CEPAL, ONU Mujeres e Infosegura). El dataset incluye 230 registros organizados por 8 categor&iacute;as: (1) Homicidios: tasas por 100,000 hab. para M&eacute;xico, Brasil, Venez

## Dataset Status
| Field | Value |
|---|---|
| Status | 🟢 Published |
| DOI | [10.5281/zenodo.18740062](https://doi.org/10.5281/zenodo.18740062) |
| Platform | Zenodo |
| License | CC0 1.0 |
| Published | 2026-02-23 |

## 🌐 Interactive Microsite
**[Open Microsite](https://juanmoisesd.github.io/evolucion-del-crimen-en-latinoamerica-2015-2024-base-de-datos-por-categorias/)**

## Keywords
crimen, homicidios, Latinoamérica, narcotráfico, violencia, seguridad, femicidio, crimen organizado

## Citation
> de la Serna Tuya, J.M. (2026). *Evolución del Crimen en Latinoamérica 2015-2024: Base de Dat*. Zenodo. https://doi.org/10.5281/zenodo.18740062
...
**APA 7**
> De la Serna Tuya, J. M. (2025). *Base de datos sobre la evoluci&oacute;n del crimen en Am&eacute;rica Latina y el Caribe durante el per&iacute;odo 2015-2024, compilada a partir de fuentes secundarias (UNODC, Insight Crime, Prosegur Research, Banco Mundial, CEPAL, ONU Mujeres e Infos* [Dataset]. GitHub. https://github.com/juanmoisesd/evolucion-del-crimen-en-latinoamerica-2015-2024-base-de-datos-por-categorias

**BibTeX**
```bibtex
@dataset{delaserna2025_evolucion_del_crimen_en_latino,
